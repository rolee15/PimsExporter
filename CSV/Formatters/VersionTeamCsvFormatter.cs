    ...
    internal class VersionTeamCsvFormatter : DocumentFormatterBase<VersionTeam>
    {
        public VersionTeamCsvFormatter() : base(CultureInfo.CurrentCulture.TextInfo.ListSeparator)
        {
            Columns = new[]
            {
                ...
                new ColumnFormatter<VersionTeam>(nameof(VersionTeam.Member), r => FormatUser(r.Member)),
                ...
                new ColumnFormatter<VersionTeam>(nameof(VersionTeam.DeputyOf), r => FormatUser(r.DeputyOf)),
