...
namespace Domain.Entities
{
    public class OmItemHeader
    {
        ...
        public string OfferingClusterSapId { get; set; }
        public string OfferingName { get; set; }
        public string OfferingNameSapId { get; set; }
        public string OfferingModule { get; set; }
        public string OfferingModuleSapId { get; set; }
        public string PortfolioUnit { get; set; }
        public string PortfolioUnitSapId { get; set; }
